...
// Each concept drives the full buildPoster() rendering pipeline.
// Pick: randomConcept() or getConcept(n)
...
export const CONCEPTS = [
  ...
  // ── 01. Lion Pride Campus ────────────────────────────────────────────────
  {
    ...
    subtitle: {
      ...
      font: '700 18px "Space Grotesk", Arial, sans-serif',
      color: '#90C878',
      y: 195,
    },
    date: { color: 'rgba(255,255,255,0.7)', y: 228 },
    photos: {
  ...
  // ── 02. Future Passport ─────────────────────────────────────────────────
  {
    ...
    date: { color: 'rgba(255,255,255,0.55)', y: 228 },
    photos: {
  ...
  // ── 03. Admissions Festival ─────────────────────────────────────────────
  {
    ...
    subtitle: {
      text: '🎉  OPEN DAY  🎉',
      font: '700 22px "Space Grotesk", Arial, sans-serif',
      color: '#FF6B35',
      y: 196,
    },
    date: { color: 'rgba(255,255,255,0.7)', y: 228 },
  ...
  // ── 04. Greenwich Champion ──────────────────────────────────────────────
  {
    ...
    subtitle: {
      text: '✦  SAY YOUR STORY  ✦',
      font: '700 20px "Space Grotesk", Arial, sans-serif',
      color: '#FFD700',
      y: 195,
    },
    date: { color: '#FFFFFF', y: 230 },
    photos: {
  ...
  // ── 05. Global Student Life ─────────────────────────────────────────────
  {
    ...
    subtitle: {
      text: '🌍  GO GLOBAL  🌍',
      font: '600 18px "Space Grotesk", Arial, sans-serif',
      color: '#90C8AC',
      y: 196,
    },
    date: { color: 'rgba(255,255,255,0.65)', y: 228 },
    photos: {
  ...
  // ── 06. Tech & Creative Lab ─────────────────────────────────────────────
  {
    ...
    subtitle: {
      ...
      font: '600 16px "Space Grotesk", monospace',
      color: 'rgba(255,107,53,0.7)',
      y: 196,
    },
    date: { color: 'rgba(255,255,255,0.45)', y: 228 },
    photos: {
  ...
  // ── 07. Lion Parade ─────────────────────────────────────────────────────
  {
    ...
    subtitle: {
      ...
      font: '700 17px "Space Grotesk", Arial, sans-serif',
      color: '#FFFFFF',
      y: 195,
    },
    date: { color: 'rgba(255,255,255,0.7)', y: 228 },
  ...
  // ── 09. Premium Minimal Brand ───────────────────────────────────────────
  {
    ...
    subtitle: {
      ...
      font: '400 15px "Space Grotesk", Arial, sans-serif',
      color: '#C9A961',
      y: 196,
    },
    date: { color: '#888', y: 228 },
    photos: {
