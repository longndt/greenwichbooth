...
export const CONCEPTS = [
  ...
  // ── 01. Open Day ────────────────────────────────────────────────────────
  {
    ...
    bg: {
      color: '#EAF7FF',
      texture: { type: 'confetti', color: 'rgba(0,95,115,0.10)', step: 42 },
    },
    header: {
      bg: '#F3FBFF',
      topBar: { color: '#0A9396', height: 10 },
      bottomBar: { colors: ['rgba(255,203,47,0.18)', '#FFCB2F'], height: 12 },
    },
    title: {
      text: 'GREENWICH VIETNAM',
      font: '800 58px "Be Vietnam Pro", Arial, sans-serif',
      color: '#005F73',
      shadow: { color: 'rgba(0,95,115,0.14)', blur: 10 },
      y: 140,
    },
    subtitle: {
    ...
    date: { color: '#005F73', y: 226 },
    photos: {
      slotShadow: 'rgba(0,95,115,0.16)',
      slotBg: '#FFFFFF',
      borderColor: '#0A9396',
      borderWidth: 4,
      radius: 18,
    ...
    footer: {
      bg: '#FFF7D1',
      borderColor: '#0A9396',
      url: { text: 'greenwich.edu.vn', color: '#005F73' },
      hashtag: { text: '#GreenwichVietnam', color: '#FF7A1A' },
    },
    frame: { outer: '#0A9396', outerW: 8, inner: '#FFCB2F', innerW: 2 },
  },
  ...
  // ── 02. Student Life ────────────────────────────────────────────────────
  {
    ...
    bg: {
      color: '#E8F4FA',
      texture: { type: 'dots', color: 'rgba(0,95,115,0.10)', step: 44 },
    },
    header: {
      bg: '#E8F4FA',
      topBar: { color: '#005F73', height: 6 },
      bottomBar: { colors: ['rgba(0,95,115,0.10)', 'rgba(0,95,115,0.24)'], height: 10 },
    },
    title: {
      text: 'GREENWICH VIETNAM',
      font: '800 56px "Plus Jakarta Sans", Arial, sans-serif',
      color: '#005F73',
      shadow: { color: 'rgba(0,95,115,0.12)', blur: 8 },
      y: 150,
    },
    subtitle: {
      text: 'STUDENT LIFE · GREENWICH MOMENT',
      font: '600 16px "Space Grotesk", Arial, sans-serif',
      color: '#007C92',
      y: 205,
    },
    date: { color: '#007C92', y: 238 },
    photos: {
      slotShadow: 'rgba(0,95,115,0.16)',
      slotBg: '#D8F3F8',
      borderColor: '#005F73',
  ...
  // ── 03. Graduation Day ──────────────────────────────────────────────────
  {
    ...
    bg: {
      color: '#EAF7FF',
      texture: { type: 'dots', color: 'rgba(0,95,115,0.12)', step: 36 },
    },
    header: {
      bg: '#F8FCFF',
      topBar: { color: '#005F73', height: 7 },
    ...
    title: {
      ...
      font: '800 56px "Plus Jakarta Sans", Arial, sans-serif',
      color: '#005F73',
      shadow: { color: 'rgba(0,95,115,0.14)', blur: 8 },
      y: 150,
    },
    subtitle: {
      text: 'GRADUATION DAY · READY TO GROW',
      font: '600 16px "Space Grotesk", Arial, sans-serif',
      color: '#0A9396',
      y: 205,
    },
    date: { color: '#005F73', y: 238 },
    photos: {
      slotShadow: 'rgba(0,95,115,0.16)',
      slotBg: '#D8F3F8',
      borderColor: '#0A9396',
      borderWidth: 3,
      radius: 10,
      cornerAccent: { color: '#EE9B00', size: 22, lw: 2 },
      emojis: ['🎓', '💼', '📈', '✨'],
    },
    footer: {
      bg: '#005F73',
      borderColor: '#94D2BD',
      url: { text: 'greenwich.edu.vn', color: '#FFFFFF' },
      hashtag: { text: '#GreenwichVietnam', color: '#FFDD66' },
    },
    frame: { outer: '#0A9396', outerW: 6, inner: '#EE9B00', innerW: 2 },
  },
